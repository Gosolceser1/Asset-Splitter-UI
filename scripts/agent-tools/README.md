...
Implements the RDA V2.2 binary format directly in PowerShell, using the [RDA File Format wiki](https://github.com/lysanntranvouez/RDAExplorer/wiki/RDA-File-Format) as a format reference.
...
- [RDA File Format Wiki](https://github.com/lysanntranvouez/RDAExplorer/wiki/RDA-File-Format) — binary format documentation (community reference)
- [Anno 1800 ModTool](https://annomodtool.wixsite.com/main) — original ModTool by Holger Eilts (Pogobuckel), source of the C# RDA library in `src/RDAExplorer/`

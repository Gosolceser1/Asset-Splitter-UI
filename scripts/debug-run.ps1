...
#
# Output goes to debug-output/ inside the repo (gitignored).
...
#   -OutputPath        Override output directory (default: debug-output/ in repo root)
...
# ============================================================
if (-not $OutputPath) {
    $OutputPath = Join-Path $ProjectRoot "debug-output"
}

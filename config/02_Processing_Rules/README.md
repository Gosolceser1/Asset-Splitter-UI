...
- The fixlist is typically similar in size to the template list (Anno 1800: 988 vs 993; Anno 117: 919 vs 945) — add only templates that benefit from merge/deps.

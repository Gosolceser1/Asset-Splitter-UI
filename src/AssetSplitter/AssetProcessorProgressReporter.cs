...
/// <summary>
/// Writes structured progress information both to <c>fixer.txt</c> (consumed by the UI)
/// and to the console (with interactive progress bar support when not redirected).
...
public class AssetProcessorProgressReporter
{
    ...
    /// <summary>Writes a line to <c>fixer.txt</c> (used by the UI to read progress). Safe to call even before Initialize.</summary>

...
public static class ConsoleMessages
{
    ...
    private static readonly Dictionary<string, string> DefaultMessages = new()
    {
        ...
        ["phase3SplitTemplatesLabel"] = "=== PHASE 2B: SPLIT TEMPLATES ===",
        ...
        ["commentsRequireLanguage"] = "GUID comments (-c) require a game language (texts_*.xml).",
        ["sourceExtractionComplete"] = "[SOURCE READY] Game files extracted to source_xml. Enable a processing option and run again to build asset XML.",
        ...
        ["helpOptionOverwrite"] = "  -y            (legacy, ignored — output folders are cleared automatically each run)",
        ...
        ["helpOptionNoDefaultProperties"] = "  --no-default-properties  Split-only: skip template merge (Phase 5) and enrichment cleanup (Phase 7 vector/regional)",
        ...
        ["clearedExistingSourceXmlFolder"] = "[INFO] Cleared existing source_xml cache folder",
        ["clearedExistingTemplateSplitFolder"] = "[INFO] Cleared existing output_templates folder",
        ["sourceXmlFolderPrepareFailed"] = "[ERROR] Could not prepare source_xml folder '{0}': {1}",
        ["modOutputFolderPrepareFailed"] = "[ERROR] Could not prepare mod output folder '{0}': {1}",
        ...
        ["formatFeatureComments"] = "Translated comments (-c)",
        ["formatFeatureFolders"] = "Template folders (-t)",
        ["formatFeatureFlaggedOnly"] = "flagged post-processing only",
        ...
        ["vectorCleanupSkippedSplitOnly"] = "  * VectorElement cleanup: Skipped (--no-default-properties / split-only)",
        ...
        ["textMetadataMissing"] = "[WARNING] Text metadata file not found: {0} (LineId dev names unavailable)",
        ["textMetadataLoadFailed"] = "[WARNING] Failed to load text metadata: {0}",
        ["textMetadataMappingsLoading"] = "[TRANS] Loading LineId dev-name metadata (texts_metadata.xml)...",
        ["textMetadataDictionaryComplete"] = "[COMPLETE] Text metadata dictionary: {0} LineId dev-name mappings ready",
        ["debugTextMetadataSource"] = "[DEBUG][TRANS] Loading text metadata file: {0}",
        ["lineIdContextLoadFailed"] = "[WARNING] Failed to build LineId context index: {0}",
        ["lineIdContextBuilding"] = "[TRANS] Building LineId context index from asset graph...",
        ["lineIdContextComplete"] = "[COMPLETE] LineId context index: {0} asset-graph labels ready",
        ...
        ["formattingRunSummary"] = "[INFO] Formatting summary: {0} files annotated ({1} comments), {2} template moves, {3} missing Template node",
        ...
        ["debugPhase7AddingComments"] = "[DEBUG] Phase 7: Adding translated GUID comments (-c enabled)",
        ["debugPhase7SkippingComments"] = "[DEBUG] Phase 7: Skipping translated comments (-c disabled)",
        ...
        ["debugParentAssetRelocated"] = "[CACHE] Parent asset {0} found at relocated path: {1}",
        ...
        ["debugFlowSplitOnlyComplete"] = "Steps 4-7: skipped (split-only — raw assets.xml split complete)",
        ["debugFlowPhase4Skipped"] = "Step 4: skipped (GUID index not needed without -c or -f)",
        ["debugFlowPhase5Skipped"] = "Step 5: skipped (--no-default-properties / template merge off)",
        ["debugFlowPhase7Skipped"] = "Step 7: skipped (no -c, -t, enrichment, or mod packages)",
        ...
        ["debugRdaArchiveSearchOrderAnno1800NewestWins"] = "[DEBUG][RDA] Archive search order: data*.rda highest index first; first write wins per bare filename (newest patch kept, no overwrite from older archives)",
        ["debugRdaAnno1800SkipExistingPolicy"] = "[DEBUG][RDA] Anno 1800 merge policy: skip bare output when file already exists (older archives cannot overwrite newer patch files)",
        ["debugRdaProcessingOrderCompact"] = "[DEBUG][RDA] Processing order: {0} -> {1} ({2} archives, highest patch index first)",
        ["debugRdaArchiveCompact"] = "[DEBUG][RDA] {0}: {1} bytes on disk, {2} entries scanned, 0 written (skipped {3} on disk, {4} filter miss)",
        ["debugRdaArchiveExtractedSummary"] = "[DEBUG][RDA] {0}: {1} bytes on disk, {2} entries scanned, {3} written (skipped {4} on disk, {5} checksum/metadata)",
        ["debugRdaAnno1800PhaseSummary"] = "[DEBUG][RDA] Anno 1800 phase summary: scanned {0}/{1} archives in {2}; {3}; {4} bare file(s) written",
        ["debugRdaAnno1800StoppedAt"] = "early stop at {0}",
        ["debugRdaAnno1800NoEarlyStop"] = "all archives scanned (no early stop)",
        ["debugRdaFileProvenanceHeader"] = "[DEBUG][RDA] Bare file provenance (first write wins - source archive for each output file):",
        ...
        ["debugRdaArchiveSummary"] = "[DEBUG][RDA] Archive '{0}': {1} entries scanned, {2} extracted, {3} skipped checksum/metadata, {4} skipped invalid path, {5} no filter match, {6} skipped (already on disk)",
        ["debugRdaEarlyStopReason"] = "[DEBUG][RDA] Early stop - all required files present: {0}",
        ["debugRdaEarlyStopRequirements"] = "[DEBUG][RDA] Early stop when all present: {0}",
        ["debugRdaArchiveReadFailed"] = "[WARNING] Could not read RDA archive '{0}': {1} - trying next archive",
        ["debugRdaContinueSearch"] = "[DEBUG][RDA] Core files still missing after {0} - still need: {1}",
        ["debugRdaBlockDetailSummary"] = "[DEBUG][RDA] Block headers: {0} parsed, {1} with files (showing first {2} file-bearing blocks)",
        ["debugRdaBlockDetailTruncated"] = "[DEBUG][RDA]   ... {0} more file-bearing block(s) omitted from log",
        ["debugRdaNoFileBearingBlocks"] = "[DEBUG][RDA] No file-bearing blocks in archive (empty or tombstone-only layout)",
        ...
        ["debugDepRemovedEmptyStagingFolder"] = "[DEBUG][DEP] Removed empty staging folder: {0}",
        ["debugGuidIndexRefreshedAfterDeps"] = "[DEBUG][GUID] Refreshed index after dependency merge: {0} entries",
        ["debugDepStagingFileDeleteFailed"] = "[DEBUG][DEP] Could not delete merged staging file {0}: {1}",
        ["debugDepStagingFolderDeleteFailed"] = "[DEBUG][DEP] Could not remove empty staging folder {0}: {1}",
        ...
        ["modDescriptionGameBuildSuffix"] = "Generated for game build {0}.",
        ...
        ["readmeGameBuildLabel"] = "- Detected game build: `{0}`",
        ["readmeGameBuildTimeLabel"] = "- Game build time: `{0}`",
        ["readmeGeneratedLocalTimeLabel"] = "- Generated local time: `{0}`",
        ...
        ["gameBuildDetected"] = "Game build: {0}",
        ...
        ["modExportBuildingPackages"] = "Building asset mod folders from {0} extracted assets...",
        ["modExportRemovedStagingFolder"] = "[INFO] Removed intermediate XML folder: {0}",
        ["modExportStagingFolderDeleteFailed"] = "[WARN] Could not remove intermediate XML folder {0}: {1}",
        ["debugModExportRemovedStaging"] = "[DEBUG][MODS] Removed intermediate XML folder: {0}",
        ...
        ["issueParentLoadFailedRootCause"] = "The GUID index still pointed at a staging path after that parent was merged to the output root, or the file could not be read.",
        ["issueParentLoadFailedHint"] = "Check that the parent file is valid XML and not locked by another process.",
        ["issueDependencyChildLoadFailedMessage"] = "Dependency child asset '{0}' could not be loaded: {1}",
        ["issueDependencyChildLoadFailedRootCause"] = "A staged BaseAssetGUID child XML file could not be read before parent properties were merged into it.",
        ["issueDependencyChildLoadFailedHint"] = "Check that the child file is valid XML and not locked by another process.",
        ...
        ["issueTitle_DependencyChildLoadFailed"] = "Dependency child failed to load",
    ...
    private static string NormalizeLanguage(string language)
    {
        ...
        return language.Trim().ToLowerInvariant() switch
        {
            ...
            "traditional_chinese" or "tchinese" => "tw",
            "mexican" => "es",
    ...
    private static string? GetConfigPath(string language)
    {
        ...
        string resolved = ConfigPathResolver.Resolve(ConsoleMessagesFolder, filename);

...
public sealed class GuidFileIndex
{
    ...
    /// <summary>Updates index after Phase 6 moves a merged asset from staging to output root.</summary>
    public void UpdatePath(string guid, string filePath)
    {

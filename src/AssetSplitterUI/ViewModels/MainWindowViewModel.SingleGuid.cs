...
public partial class MainWindowViewModel
{
    private void ScheduleSingleGuidLookup()
    {
        ...
        if (guid.Length == 0)
        {
            ...
            _lastSingleGuidLookupGuid = null;
            _lastSingleGuidLookupResult = null;
    ...
    {
        _lastSingleGuidLookupGuid = guid;
        _lastSingleGuidLookupResult = result;
    ...
    private void RefreshSingleGuidStatusText()
    {
        if (_lastSingleGuidLookupGuid is not null
            && _lastSingleGuidLookupResult is not null
            && SingleGuid.Trim().Equals(_lastSingleGuidLookupGuid, StringComparison.Ordinal))
        {
            ApplySingleGuidLookupResult(_lastSingleGuidLookupGuid, _lastSingleGuidLookupResult);
        }
    }

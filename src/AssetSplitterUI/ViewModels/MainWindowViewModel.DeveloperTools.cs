...
public partial class MainWindowViewModel
{
    ...
    [ObservableProperty]
    private bool _developerOptionsUnlocked;
    ...
    {
        var path = GetResolvedAnnoAssetsPath();
    ...
    {
        string languageForReport = _lastRunBackendAssetLanguage ?? (string.IsNullOrEmpty(SelectedLanguage)
            ? "none"
            : SelectedLanguage.ToLowerInvariant());
        ...
        var annoAssetsPath = GetResolvedAnnoAssetsPath();
        var sourceXmlPath = GetResolvedSourceXmlPath(annoAssetsPath);

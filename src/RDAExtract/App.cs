...
internal sealed class App
{
    ...
    public static int Main(string[] args)
    {
        ...
        if (dataSeries.Length > 0)
        {
            ...
            foreach (DataRdaFile item in ordered)
            {
                ...
                ProcessSingleRda(item.File.FullName, outDir, match, bare, listOnly, skipExistingBareOutput: bare);
            }
            return 0;
        }
    ...
    private static void ShortHelp()
    {
        ...
        string versionStr = version is not null ? $"{version.Major}.{version.Minor}" : "1.0";
        Console.WriteLine("");
        Console.WriteLine("----------------------------------");
    ...
    private static void ProcessSingleRda(
        string rdaFilePath,
        string outDir,
        string match,
        bool bare,
        ...
        bool skipExistingBareOutput = false)
    {
        ...
        else
        {
            ...
            RDAFileExtension.ExtractAll(rdaFilePath, outDir, match, bare, skipExistingBareOutput);

<p align="center">
  <img width="200" alt="Asset Splitter logo" src="assets/branding/logo.png" />
</p>
...
![Dark theme](assets/screenshots/screenshot-dark.png)

![Light theme](assets/screenshots/screenshot-light.png)
...
Based on Holger Eilts (Pogobuckel)'s AssetSplit concept and ModTool library (AssetSplit + RDA archive reader).
